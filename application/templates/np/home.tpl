...
[{include file=$smarty.const.APPPATH|cat:"templates/np/widget/slider.tpl"}]
        ...
        <div class="out-service-box cls">
            <div class="left cover" style="background-image:url(assets/np/images/service-bg.jpg)">
...
[{include file=$smarty.const.APPPATH|cat:"templates/np/widget/partner-slider.tpl"}]
