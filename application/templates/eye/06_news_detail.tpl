...
[{include file=$smarty.const.APPPATH|cat:"templates/eye/inc/head.tpl"}]
        ...
        <div class="becu">
            <div class="container">
            Home / Latest News / [{$content_detail->_title|escape:'html'}]
            </div>
        </div>
        <div class="about-detail">
            <div class="container">
                <div class="row">
                    ...
                    <a href="[{'news/'|cat:$prev->_alias|escape:'html'|base_url}]" class="about-prev">[{$prev->_title|escape:'html'|default:'&nbsp;'}]</a>
                    <a href="/news" class="about-menu"></a>
                    <a href="[{'news/'|cat:$next->_alias|escape:'html'|base_url}]" class="about-next">[{$next->_title|escape:'html'|default:'&nbsp;'}]</a>
                    <div class="clearfix"></div>
                    </div>
                </div>
            </div>
