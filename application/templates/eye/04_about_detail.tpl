...
[{include file=$smarty.const.APPPATH|cat:"templates/eye/inc/head.tpl"}]
        ...
        <div class="becu">
            <div class="container">
            About / About AE&LC / [{$content_detail->_title|escape:'html'}]
            </div>
        </div>
        <div class="about-detail">
            <div class="container">
                <div class="row">
                    ...
                    <a href="[{'about/'|cat:$prev->_alias|escape:'html'|base_url}]" class="about-prev">[{$prev->_title|escape:'html'|default:'&nbsp;'}]</a>
                    <a href="/about" class="about-menu"></a>
                    <a href="[{'about/'|cat:$next->_alias|escape:'html'|base_url}]" class="about-next">[{$next->_title|escape:'html'|default:'&nbsp;'}]</a>
                    <div class="clearfix"></div>
                    </div>
                </div>
            </div>
