...
<html lang="en">
    <head>
        ...
        <script type="text/javascript" src="/assets/eye/bootstrap/js/jquery-1.9.1.min.js"></script>
        <script type="text/javascript" src="/assets/eye/bootstrap/js/bootstrap.js"></script>
        <script type="text/javascript" src="/assets/eye/plugin/owl-carousel/owl.carousel.js"></script>
        <script type="text/javascript" src="/assets/eye/plugin/jquery.nailthumb.1.1.js"></script>
        <script type="text/javascript" src="/assets/eye/plugin/jquery.lazyload.min.js"></script>
        <script type="text/javascript" src="/assets/eye/js/main.js"></script>
