...
[{include file=$smarty.const.APPPATH|cat:"templates/eye/inc/head.tpl"}]
        ...
        <div class="becu">
            <div class="container">
            Service / [{$selected_cat->cat_title}] / [{$content_detail->_title|escape:'html'}]
            </div>
        </div>
        <div class="about-detail">
            <div class="container">
                <div class="row">
                    ...
                    <a href="[{'services/'|cat:$selected_cat->cat_alias|escape:'html'|cat:'/'|cat:$prev->_alias|escape:'html'|base_url}]" class="about-prev">[{$prev->_title|escape:'html'|default:'&nbsp;'}]</a>
                    <a href="/services" class="about-menu"></a>
                    <a href="[{'services/'|cat:$selected_cat->cat_alias|escape:'html'|cat:'/'|cat:$next->_alias|escape:'html'|base_url}]" class="about-next">[{$next->_title|escape:'html'|default:'&nbsp;'}]</a>
                    <div class="clearfix"></div>
                    </div>
                </div>
            </div>
