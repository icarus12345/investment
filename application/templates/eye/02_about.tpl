                ...
                <div class="row">
                    ...
                    <div class="item col-sm-6 col-md-4">
                        <div>
                            ...
                            [{if $foo->_id==77}]
                            <a href="[{'about/meet-the-team'|base_url}]"><div class="btn btn-info">Read more</div></a>
                            [{else}]
                            <a href="[{'about/'|cat:$foo->_alias|escape:'html'|base_url}]"><div class="btn btn-info">Read more</div></a>
                            [{/if}]
                        </div>
                    </div>
                    [{/foreach}]
