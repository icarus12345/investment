        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                <div class="page-content">
                    ...
                    [{include file=$smarty.const.APPPATH|cat:"templates/dashboard/cp/seo/pageheader.tpl"}]
                    <!-- BEGIN PAGE CONTENT-->
                    <!-- <div class="row">
                            <div class="col-md-12">
                    ...
                    <div>
                        ...
                        <script type="text/javascript" src="/dashboard/cp/seo/loadscript/app/[{$unit}]"></script>
